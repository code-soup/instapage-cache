...
use CodeSoup\InstapageCache\Providers\AdminServiceProvider;
use CodeSoup\InstapageCache\Providers\FrontendServiceProvider;
use CodeSoup\InstapageCache\Providers\CachingServiceProvider;
...
final class Plugin {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'instapage-cache' ), '1.0.0' );
	}
